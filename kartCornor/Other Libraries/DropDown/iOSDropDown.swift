...
open class DropDown : UITextField {
    ...
    public var optionArray = [NSAttributedString]() {
        didSet{
...
//                }
    ...
    //MARK: Closures
    fileprivate var didSelectCompletion: (NSAttributedString, Int ,Int) -> () = {selectedText, index , id  in }
    ...
    func setupUI () {
        ...
        self.font = UIFont(name: "Helvetica Bold", size: 12.0)
    ...
    public func didSelect(completion: @escaping (_ selectedText: NSAttributedString, _ index: Int , _ id:Int ) -> ()) {
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.textLabel?.font = UIFont.init(name: "Helvetica", size: 11)
        cell!.textLabel!.attributedText = dataArray[indexPath.row]
